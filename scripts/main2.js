...
ratio0ToPrice = (amount0In, amount1Out) => {
  ...
  return 1 / (Number(amount0In) / Number(amount1Out) / 10 ** (18 - 8));
};
...
var WETH_WBTC_V2 = "0xBb2b8038a1640196FbE3e38816F3e67Cba72D940"; // replace with actual address
var WETH_WBTC_SUSHI = "0xceff51756c56ceffca006cd410b03ffc46dd3a58"; // replace with actual address
...
var v2Pair = new ethers.Contract(WETH_WBTC_V2, v2PairArtifact.abi, provider);
...
async function PriceUpdate() {
  try {
    ...
    console.log("Gas cost in eth: " + formattedNum);
    ...
    var spreadP = ((uniswapPrice - sushiPrice) / uniswapPrice) * 100;
    ...
    const EX2V =
      EX1V / sushiPrice - uniswapPrice * ((EX1V / sushiPrice) * 0.003);
    ...
    var spreadfromsushiP = ((sushiPrice - uniswapPrice) / sushiPrice) * 100;
    ...
    const EX2S =
      EX1S / uniswapPrice - sushiPrice * ((EX1S / uniswapPrice) * 0.003);
